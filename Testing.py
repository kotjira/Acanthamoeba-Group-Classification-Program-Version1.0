...
def demo_photo_picker3(default_folder, default_pic):
    ...
    layout = [
        [
            sg.Menu(menu_def, tearoff=False, pad=(200, 1),background_color ='#1a1a1a'),
    ...
    window = sg.Window('Acanthamoeba Group Classification Program',layout,icon="GUI\icon_program.ico")
